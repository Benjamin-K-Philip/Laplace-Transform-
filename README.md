...
➤ **Distinguishing and Classification:** <br>
   ...
   - **Inverse Laplace Problems (Question 2):** These are identified by rational functions of $\boldsymbol{p}$. They are classified based on their denominators—specifically those requiring Completing the Square or recognizing Shifted Power/Trig forms.
